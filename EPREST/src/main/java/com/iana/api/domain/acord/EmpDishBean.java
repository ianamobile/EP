/*
 *  File		: EmpDishBean.java
 *  Author		: Ashok Soni
 *  Created		: June 16,2006
 *  Description	: Bean for Employee Dishonesty Bond Policy
...
public class EmpDishBean extends PolicyMasterBean implements IAPolicyBeanInterface
{
